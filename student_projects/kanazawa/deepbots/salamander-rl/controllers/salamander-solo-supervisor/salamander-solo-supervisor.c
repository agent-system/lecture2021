...
int main() {
  ...
  for (i = 0; i < ROBOTS; i++) {
    ...
    node = wb_supervisor_node_get_from_def("salamander");
  ...
  node = wb_supervisor_node_get_from_def("w-ball");
  ...
  while (wb_robot_step(TIME_STEP) != -1) {
    ...
    /* printf("ball  translation = %g %g %g\n",ball_translation[0],ball_translation[1],ball_translation[2]); */
    /* printf("salamander translation = %g %g %g\n",robot_translation[0][0],robot_translation[0][1],robot_translation[0][2]); */
    /* printf("salamander rotation = %g %g %g %g\n",robot_rotation[0][0],robot_rotation[0][1],robot_rotation[0][2],robot_rotation[0][3]); */
