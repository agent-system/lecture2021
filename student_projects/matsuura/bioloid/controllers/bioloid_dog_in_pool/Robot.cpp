...
void Robot::swimpose() {
  setMotorPosition(NECK_1, -M_PI/2);
  // setMotorPosition(NECK_1, -M_PI/4);
  setMotorPosition(FRONT_RIGHT_1, M_PI / 2);
  setMotorPosition(FRONT_LEFT_1, M_PI / 2);
  setMotorPosition(FRONT_RIGHT_2, M_PI / 2);
  setMotorPosition(FRONT_LEFT_2, -M_PI / 2);
  setMotorPosition(BACK_RIGHT_1, M_PI / 2);
  setMotorPosition(BACK_LEFT_1, M_PI / 2);
  setMotorPosition(BACK_RIGHT_2, -M_PI / 2);
  setMotorPosition(BACK_LEFT_2, M_PI / 2);
  // setMotorPosition(BACK_RIGHT_3, -M_PI * 5/6);
  // setMotorPosition(BACK_LEFT_3, M_PI * 5/6);
  wait(1);
}
void Robot::swimpose2() {
  setMotorPosition(NECK_1, -M_PI/2);
  // setMotorPosition(NECK_1, -M_PI/4);
  setMotorPosition(FRONT_RIGHT_1, M_PI / 2);
  setMotorPosition(FRONT_LEFT_1, M_PI / 2);
  ...
  setMotorPosition(BACK_RIGHT_2, -M_PI / 2);
  setMotorPosition(BACK_LEFT_2, -M_PI / 2);
  setMotorPosition(BACK_RIGHT_3,0);
  setMotorPosition(BACK_LEFT_3, 0);
  wait(1);
}
void Robot::swimming() {
  // ROBOT::swimpose()
  int i=0;
    while(true){
      setMotorPosition(BACK_RIGHT_1, M_PI/2  * i);
      setMotorPosition(BACK_LEFT_1, M_PI/2  * i);
      setMotorPosition(FRONT_RIGHT_1, M_PI/2  * i);
      setMotorPosition(FRONT_LEFT_1, M_PI/2  * i);
      // wait(0.05);
      wait(0.1);      
      i++;
    // simulator step
...
void Robot::swimming2() {
  ...
  int i=0,j=0;
    while(true){
      ...
      setMotorPosition(BACK_RIGHT_1, j);
      setMotorPosition(BACK_LEFT_1, j);
