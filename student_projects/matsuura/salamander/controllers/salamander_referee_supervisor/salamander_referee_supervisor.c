...
int main() {
  /* const char *robot_name[ROBOTS] = {"A1", "A2", "A3", "B1", "B2", "B3"}; */
  ...
  /*                                                {-0.3, 0.03817, 0.2}, {-0.3, 0.03817, -0.2}, {-0.75, 0.03817, 0}}; */
    double robot_initial_translation[ROBOTS][3] = {{-1.0, 0.3, 0.4}, {-1.0, 0.3, 0}, {-1.0, 0.3, -0.4},
                                                   {1.0, 0.3, 0.4}, {1.0, 0.3, 0}, {1.0, 0.3, -0.4}};
  /* double robot_initial_rotation[ROBOTS][4] = {{0, 1, 0, 1.57}, {0, 1, 0, 1.57}, {0, 1, 0, 3.14}, */
  /*                                             {0, 1, 0, 1.57}, {0, 1, 0, 1.57}, {0, 1, 0, 3.14}};  */
  double robot_initial_rotation[ROBOTS][4] = {{0, 1, 0, -1.57}, {0, 1, 0, -1.57}, {0, 1, 0, -1.57},
                                              {0, 1, 0, 1.57}, {0, 1, 0, 1.57}, {0, 1, 0, 1.57}};  
