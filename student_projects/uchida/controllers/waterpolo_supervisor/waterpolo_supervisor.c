...
int main() {
  const char *robot_name[ROBOTS] = {"R1", "R2", "R3"};
  WbNodeRef node;
  ...
  double ball_initial_translation[3] = {-1, 0.2, 0};
  double robot_initial_translation[ROBOTS][3] = {{-2.0, 0.3, 1}, {-4.0, 0.3, 0}, {-2.0, 0.3, -1}};
  double robot_initial_rotation[ROBOTS][4] = {{0, 1, 0, -1.5708}, {0, 1, 0, -1.5708}, {0, 1, 0, -1.5708}};
  ...
  while (wb_robot_step(TIME_STEP) != -1) {
    ...
    wb_supervisor_set_label(2, time_string, 0.45, 0.01, 0.1, 0xffffff, 0.0, "Arial");  // black
